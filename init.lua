...
require('lazy').setup({
  ...
  {
    -- Autocompletion of brackets closing 
...
local function format_and_back()
...
require('which-key').add {
  ...
  },
  {
    ...
    {"", group = '[T]oggle'},
    {"", group = '[W]orkspace'},
    {"", desc="", hidden = true, mode = {"v","v","v","v","v","v","v","v"} },
  }
}
...
require('mason-lspconfig').setup({
  ensure_installed = {"pylsp", "pyright", "clangd", "html-lsp"},
})
...
-- Autocompletion config using defalt settings for now
-- plugin name m4xshen/autoclose.vim
